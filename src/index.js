  ...
  <div>
    ...
    <table>
        ...
        <tr>
            <td>Captain</td>
            <td>Noah Büttner</td>
            <td>buttnern22@lsrhs.net</td>
        </tr>
        <tr>
            <td>Captain</td>
            <td>Andrew Sills</td>
            <td>sillsa22@lsrhs.net</td>
        </tr>
        <tr>
            <td>Co-Captain</td>
            <td>Eron Leung</td>
